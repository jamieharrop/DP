...
<title>Dyad Productions - Privacy Policy</title>

<?php include("includes/head.php"); ?>

</head>

<body class="sub" id="cookie-policy">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<p>We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together to compile data regarding the actions of our website visitors as they browse our website.</p>
						...
						<p>http://www.dyadproductions.com<br />
						<span id="email-container"></span></p>
						
						<p>Last Edited on 2018-05-31</p>
					</div>
				</div>
			</div>
		</div>
